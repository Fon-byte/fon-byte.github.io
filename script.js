...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const storyPrompts = [
        ...
        { category: "Fantasy", text: "A city where everyone is born with a unique magical flaw, and one person’s flaw is the key to saving the world." },
        { category: "Fantasy", text: "A magical train that travels between worlds, and a stowaway who doesn’t know which world they belong to." },
        { category: "Fantasy", text: "A festival where wishes come true for one night, but the cost is forgotten memories." },
        { category: "Fantasy", text: "A kingdom where dreams are taxed, and a dream-thief who wants to set the people free." },
        { category: "Fantasy", text: "A talking animal companion who is actually a cursed prince, trying to break their own curse." },
        ...
        { category: "Sci-Fi", text: "A scientist discovers a parallel universe where humanity never existed, but something else is watching." },
        { category: "Sci-Fi", text: "A hacker stumbles upon a digital consciousness living in the internet, begging for help." },
        { category: "Sci-Fi", text: "A planet where time runs backward, and a rescue mission must adapt to survive." },
        { category: "Sci-Fi", text: "A city where everyone is required to wear emotion-masking technology, and one person rebels by showing their true feelings." },
        { category: "Sci-Fi", text: "A spaceship crew wakes up from cryosleep to find their ship orbiting an unknown star system with no memory of their mission." },
        ...
        { category: "Mystery/Thriller", text: "A detective who solves crimes by reading the patterns in spilled coffee." },
        { category: "Mystery/Thriller", text: "A locked-room mystery where the only clue is a single, perfectly preserved snowflake." },
        { category: "Mystery/Thriller", text: "A person receives anonymous phone calls that predict crimes before they happen." },
        { category: "Mystery/Thriller", text: "A novelist discovers their fictional murders are being recreated in real life." },
        { category: "Mystery/Thriller", text: "A missing person case where every suspect has the same alibi: they were all together, but none remember what happened." },
        ...
        { category: "Contemporary/Slice of Life", text: "A barista who writes secret poems on coffee cups for regulars, changing their lives in small ways." },
        { category: "Contemporary/Slice of Life", text: "A group of neighbors starts a midnight book club to cope with insomnia." },
        { category: "Contemporary/Slice of Life", text: "A teacher who helps students discover their hidden talents through unconventional lessons." },
        { category: "Contemporary/Slice of Life", text: "A person who documents the stories of strangers they meet on the bus every morning." },
        { category: "Contemporary/Slice of Life", text: "A family-run laundromat becomes the heart of a community during a citywide blackout." },
        ...
        { category: "Horror", text: "A haunted painting that changes every night, revealing the fate of its next victim." },
        { category: "Horror", text: "A town where everyone wakes up with a different face each morning, and no one knows why." },
        { category: "Horror", text: "A child’s imaginary friend starts appearing in the dreams of everyone in the neighborhood." },
        { category: "Horror", text: "A hotel where guests check in but their reflections never leave." },
        { category: "Horror", text: "A mysterious fog rolls into town, and those who enter it are never the same." },
        ...
        { category: "Historical", text: "A painter in the French Revolution encodes secret messages in their artwork for the resistance." },
        { category: "Historical", text: "A medieval healer accused of witchcraft must prove their innocence during a plague outbreak." },
        { category: "Historical", text: "A scribe in ancient Egypt discovers a prophecy hidden in the stars." },
        { category: "Historical", text: "A samurai is forced to choose between loyalty to their lord and saving a forbidden love." },
        { category: "Historical", text: "A Viking explorer finds a land of perpetual night and must solve its mystery to return home." },
        ...
        { category: "Adventure", text: "A treasure hunter must solve a series of riddles left by their ancestor to find a lost civilization." },
        { category: "Adventure", text: "A pilot crash-lands in the desert and discovers an underground city of glass." },
        { category: "Adventure", text: "A botanist searching for a legendary flower in the rainforest finds a tribe untouched by time." },
        { category: "Adventure", text: "A child finds a magical compass that points to their heart’s true desire, leading to an unexpected journey." },
        { category: "Adventure", text: "A retired explorer is called back for one last mission when a mythical beast is spotted in the wild." },
        ...
        { category: "Romance", text: "A baker and a florist team up for a wedding and discover their talents are a perfect match." },
        { category: "Romance", text: "A person falls for their best friend’s sibling during a summer road trip." },
        { category: "Romance", text: "A shy librarian writes anonymous love letters to a regular patron, never expecting a reply." },
        { category: "Romance", text: "A couple who broke up years ago are forced to work together to plan a mutual friend’s wedding." },
        { category: "Romance", text: "A travel photographer and a local tour guide fall in love while searching for a legendary landmark." },
